...
<div class="container">
    ...
    <form method="POST" action="{{ route('incidents.update', $incident) }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <input type="date" name="incident_date" class="input-date" placeholder="Incident Date" value="{{ old('incident_date', $incident->incident_date) }}" required>
        </div>
        <div class="form-row">
            ...
            <div class="event-details">
                <input type="text" name="incident_type" class="input-text" placeholder="INCIDENT NAME" value="{{ old('incident_type', $incident->incident_type) }}" required>
                <textarea name="incident_description" class="input-textarea" rows="4" placeholder="DESCRIPTION OF THE INCIDENT" required>{{ old('incident_description', $incident->incident_description) }}</textarea>
            </div>
        </div>
